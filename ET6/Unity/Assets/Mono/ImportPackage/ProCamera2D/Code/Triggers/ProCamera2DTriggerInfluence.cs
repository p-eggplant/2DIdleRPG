...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class ProCamera2DTriggerInfluence : BaseTrigger
    {
        ...
        public float InfluenceSmoothness = .65f;

        [RangeAttribute(0, 1)]
        public float ExclusiveInfluencePercentage = 0f;
        ...
        Vector3 m_v3Scale = Vector3.zero;

        protected override void Awake()
        {
            base.Awake();
            m_v3Scale = transform.localScale;
        }

        void Start()
        {
            this.ProCamera2D = null;
        ...
        private IEnumerator ScaleReset()
        {
            //yield return new WaitForSeconds(UpdateInterval);
            yield return null;
            transform.localScale = m_v3Scale;
        }
