...
namespace xasset
{
    public class BuildVersions : ScriptableObject
    {
        ...
        private void Load()
        {
            ...
            foreach (var version in data) nameWithVersion[version.name] = version;
        }

        public void Set(string build, string file, long size, long time, string hash, string gameVersion = "")
        {
