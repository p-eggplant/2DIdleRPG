...
public class SQLiteQuery {
    ...
    {
        Sqlite3.sqlite3_exec(sqlDb.GetDB(), "begin transaction;", 0, 0, 0);
    }

    public void EndTransaction()
    {
        Sqlite3.sqlite3_exec(sqlDb.GetDB(), "commit transaction", 0, 0, 0);
    }
    ...
    public bool IsFieldExist(string field)
    {
    ...
    public bool IsFieldExist(string field,out int nFieldIndex)
    {
        nFieldIndex = 0;
        for (int i = 0; i < columnNames.Length; i++)
        {
    ...
    public string GetString(int nFieldIndex)
    {
        int i = nFieldIndex;
        if (Sqlite3.SQLITE_TEXT == columnTypes[i])
        {
        ...
        throw new Exception("SQLite wrong field index (expecting String) : " + nFieldIndex.ToString());
    }
    ...
    public int GetInteger(int nFieldIndex)
    {
        int i = nFieldIndex;
        if (Sqlite3.SQLITE_INTEGER == columnTypes[i])
        {
        ...
        throw new Exception("SQLite wrong field index (expecting Integer) : " + nFieldIndex.ToString());
    }
    ...
    public long GetLong(int nFieldIndex)
    {
        int i = nFieldIndex;
        if (Sqlite3.SQLITE_INTEGER == columnTypes[i])
        {
    ...
    public DateTime GetDateTime(int nFieldIndex)
    {
        int i = nFieldIndex;
        if (Sqlite3.SQLITE_INTEGER == columnTypes[i])
        {
    ...
    public double GetDouble(int nFieldIndex)
    {
        int i = nFieldIndex;
        if (Sqlite3.SQLITE_FLOAT == columnTypes[i])
        {
        ...
        throw new Exception("SQLite wrong field index (expecting Double) : " + nFieldIndex.ToString());
    }
    ...
    public byte[] GetBlob(int nFieldIndex)
    {
        int i = nFieldIndex;
        if (Sqlite3.SQLITE_BLOB == columnTypes[i])
        {
        ...
        throw new Exception("SQLite wrong field index (expecting byte[]) : " + nFieldIndex.ToString());
    }
