...
Shader "Spine/SkeletonGraphicReplace"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag (VertexOutput IN) : SV_Target
			{
				...
				if (abs(color.r - _TargetColor.r) < _TargetRange && abs(color.g - _TargetColor.g) < _TargetRange && abs(color.b - _TargetColor.b) < _TargetRange) 
				{
					color.rgb = _ReplaceColor.rgb;
				}
